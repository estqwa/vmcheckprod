...
type Result struct {
	...
	EliminatedOnQuestion *int      `gorm:"default:null" json:"eliminated_on_question,omitempty"`
	EliminationReason    *string   `gorm:"size:50;default:null" json:"elimination_reason,omitempty"`
